...
public class APIManager : MonoBehaviour
{
    ...
    public void AddPoints(int points, Action<bool, string> onComplete = null)
    {
        ...
        StartCoroutine(AddPointsRoutine(points, onComplete));
    }

    private IEnumerator AddPointsRoutine(int pointsValue, Action<bool, string> onComplete)
    {
        AddPointsRequest requestData = new AddPointsRequest { points = pointsValue.ToString() };
        string jsonData = JsonUtility.ToJson(requestData);
